...
import { IconTrendingUp, IconTrendingDown, IconCalendar, IconBarChart, IconSparkles, IconTarget, IconZap, IconStar } from './icons'

export default function PerformanceHeatmap({ trades, onDateClick = null }) {
